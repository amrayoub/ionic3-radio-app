...
// import { LocalGenres } from '../../app/globals/data';
import { Observable } from 'rxjs/Observable';
import "rxjs/add/observable/of";
import { GenreBrowserPage } from '../genre-browser/genre-browser';
...
export class HomePage implements OnInit,AfterViewInit,OnDestroy{
  ...
  ngOnInit(){
    // this.file = this.media.create('http://listen.181fm.com/181-beatles_64k.aac')
